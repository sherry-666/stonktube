      ...
      <div className="mx-auto flex max-w-container items-center gap-7 px-7" style={{ height: 66 }}>
        ...
        <div ref={containerRef} className="ml-auto relative">
          ...
          <input
            ...
            className="w-[230px] rounded-[10px] border border-border bg-white pl-8 pr-8 py-2 text-sm text-primary placeholder:text-faint focus:outline-none focus:border-accent transition-colors"
          />
          {query && (
            <button
              onClick={clear}
